...
TrustBar.IO currently interfaces with EtherDelta's original smart contract (described in more detail [here](https://www.reddit.com/r/EtherDelta/comments/6kdiyl/smart_contract_overview/)) which allows TrustBar.IO users to trade utilizing EtherDelta's volume.


# What is the Roadmap for TrustBar.IO?
The TrustBar.IO Roadmap is maintained at https://forkdelta.app/about/
